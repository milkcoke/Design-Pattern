package pattern.behavior.strategy.tobe;

import pattern.behavior.strategy.tobe.light.BlueLightRedLight;
import pattern.behavior.strategy.tobe.light.FastestSpeedStrategy;
import pattern.behavior.strategy.tobe.light.NormalSpeedStrategy;
